...
func (c *apiServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/taehoio.idl.services.api.v1.ApiService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/taehoio.idl.services.api.v1.ApiService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApiService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taehoio.idl.services.api.v1.ApiService/HealthCheck",
	}
...
func _ApiService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taehoio.idl.services.api.v1.ApiService/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ApiService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "taehoio.idl.services.api.v1.ApiService",
	...
	Metadata: "taehoio/idl/services/api/v1/api.proto",
}
